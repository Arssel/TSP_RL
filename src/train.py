...
def train_old(actor, critic, device="cpu", batch_size=256, batch_times=40, gamma=0.99, lr=1e-4, epochs=200, T=200, TSP_size=20, n=4, decay=0.99):
    ''' 
    ...
    for e in tqdm(range(epochs)):
        ...
        for batch_time in range(batch_times):
            ...
            writer.add_scalar('Mean total reward', total_reward.mean(), batch_time + e*batch_times)
